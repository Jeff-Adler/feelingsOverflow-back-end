...
for i in 0...20 do
    ...
    post = Post.create!(positive: Faker::Lorem.sentence(word_count: 3), negative: Faker::Lorem.sentence(word_count: 3), severe: severe, category: Faker::SlackEmoji.activity, poster_id: user.id, poster_name: user.username)
